...
const $$page = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const pageParam = parseInt(Astro2.params.page || "1", 10);
  ...
  return renderTemplate`${renderComponent($$result, "List", $$List, { "channel": channel, "currentPage": currentPage, "hasNext": hasNext })}`;
}, "/www/wwwroot/baoxiao.fun/app/src/pages/page/[page].astro", void 0);

const $$file = "/www/wwwroot/baoxiao.fun/app/src/pages/page/[page].astro";
const $$url = "/page/[page]";
