...
const $$Base = createComponent(($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Base;
  const { SITE_URL, RSS_URL, RSS_PREFIX } = Astro2.locals;
  ...
  return renderTemplate(_a || (_a = __template(["<html", "", '> <head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1, viewport-fit=cover"><!-- theme-color for light/dark to improve mobile PWA appearance --><meta name="theme-color" content="#f4f1ec" media="(prefers-color-scheme: light)"><meta name="theme-color" content="#0b0b0e" media="(prefers-color-scheme: dark)"><meta name="apple-mobile-web-app-capable" content="yes"><meta name="apple-mobile-web-app-status-bar-style" content="black-translucent"><link rel="alternate" type="application/rss+xml"', "", "><style>\n      @view-transition {\n        navigation: auto; /* enabled */\n      }\n    </style>", "<!-- 仅注入 HTML 片段，避免纯文本出现在页面上 -->", "", '</head> <body> <div id="wrapper"> <div id="container"> <div id="main-container"> ', ' </div> </div> </div> <!-- 搜索弹窗（原生 popover） --> <form id="search-popover" class="search-modal"', ' method="get" popover hidden> ', ' <input type="text" name="q" placeholder="搜索" autofocus> <div class="search-hint">按 Enter 搜索 · Esc 关闭</div> </form> <a href="#wrapper" id="back-to-top" aria-label="Back to top"> <img', ' alt="Back to Top"> </a>  ', "  ", ` <script>
      // 单实例防抖（避免重复注入）
      ...
      .search-modal:popover-open, .search-modal.open {
       ...
       .search-modal input[name="q"]:focus {
         border-color: color-mix(in srgb, var(--border-color) 60%, #4c8bf5 40%);
         box-shadow: 0 0 0 3px rgba(76,139,245,.15), inset 0 1px 2px rgba(0,0,0,.06);
         background: var(--cell-background-color);
       }
       .search-hint {
         margin-top: 8px;
    ...
    </style> </body> </html>`])), addAttribute(locale ?? "en", "lang"), addAttribute(theme !== "auto" ? theme : null, "data-theme"), addAttribute(`${RSS_PREFIX}${siteTitle}`, "title"), addAttribute(RSS_URL, "href"), renderComponent($$result, "SEO", $$SEO, { "titleDefault": pageTitle, "twitter": {
    card: "summary_large_image",
    creator: twitter ? `@${twitter}` : void 0
  }, ...seoParams }), headerInjectSafe && renderTemplate`${renderComponent($$result, "Fragment", Fragment, {}, { "default": ($$result2) => renderTemplate`${unescapeHTML(headerInjectSafe)}` })}`, renderHead(), renderSlot($$result, $$slots["default"]), addAttribute(searchAction, "action"), GOOGLE_SEARCH_SITE ? renderTemplate`<input type="hidden" name="as_sitesearch"${addAttribute(GOOGLE_SEARCH_SITE, "value")}>` : null, spreadAttributes(backToTopIcon), icp ? renderTemplate`<div class="icp-footer"><span${addAttribute(icp, "innerHTML")}></span></div>` : null, footerInjectSafe && renderTemplate`${renderComponent($$result, "Fragment", Fragment, {}, { "default": ($$result2) => renderTemplate`${unescapeHTML(footerInjectSafe)}` })}`);
...
const rss = new Proxy({"src":"/_astro/rss.iDv8YLRx.svg","width":310,"height":310,"format":"svg"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/www/wwwroot/baoxiao.fun/app/src/assets/rss.svg";
							}
...
const $$Header = createComponent(($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Header;
  const { SITE_URL, RSS_URL } = Astro2.locals;
  const { channel } = Astro2.props;
  ...
  return renderTemplate`${maybeRenderHead()}<div id="header" data-astro-cid-hpnw4vwy> <a${addAttribute(SITE_URL, "href")}${addAttribute(siteTitle, "title")} data-astro-cid-hpnw4vwy> <img${addAttribute(headerImgSrc, "src")}${addAttribute(siteTitle, "alt")} loading="eager" class="header-avatar" data-astro-cid-hpnw4vwy> </a> <div class="header-title" data-astro-cid-hpnw4vwy> <a${addAttribute(SITE_URL, "href")} class="site-title"${addAttribute(siteTitle, "title")} data-astro-cid-hpnw4vwy> ${siteTitle} </a> ${siteSubtitle && renderTemplate`<div class="site-subtitle" data-astro-cid-hpnw4vwy>${siteSubtitle}</div>`} </div> <div class="header-icons" data-astro-cid-hpnw4vwy> ${!isHidden("RSS") && renderTemplate`<a${addAttribute(RSS_URL, "href")} target="_blank" rel="alternate" type="application/rss+xml" title="RSS Feed" data-astro-cid-hpnw4vwy> <img${spreadAttributes(rss)} alt="RSS" class="social-icon" width="1em" data-astro-cid-hpnw4vwy> </a>`} ${PODCASRT && !isHidden("PODCAST", "PODCASRT") && renderTemplate`<a${addAttribute(PODCASRT, "href")} target="_blank" title="Podcast" data-astro-cid-hpnw4vwy> <img${spreadAttributes(podcast)} alt="Podcast" class="social-icon" width="1em" data-astro-cid-hpnw4vwy> </a>`} ${TWITTER && TWITTER.length > 0 && !isHidden("TWITTER") && renderTemplate`<a${addAttribute(`https://twitter.com/${TWITTER}`, "href")} title="Twitter" target="_blank" data-astro-cid-hpnw4vwy> <img${spreadAttributes(twitter)}${addAttribute(`twitter.com/${TWITTER}`, "alt")} class="social-icon" width="1em" data-astro-cid-hpnw4vwy> </a>`} ${GITHUB && GITHUB.length > 0 && !isHidden("GITHUB") && renderTemplate`<a${addAttribute(`https://github.com/${GITHUB}`, "href")} title="GitHub" target="_blank" data-astro-cid-hpnw4vwy> <img${spreadAttributes(github)}${addAttribute(`github.com/${GITHUB}`, "alt")} class="social-icon" width="1em" data-astro-cid-hpnw4vwy> </a>`}  ${!isHidden("SEARCH") && renderTemplate`<a href="#" title="搜索" data-popover="search-popover" data-astro-cid-hpnw4vwy> <img${spreadAttributes(search)} alt="Search" class="social-icon" width="1em" data-astro-cid-hpnw4vwy> </a>`} ${DISCORD && DISCORD.length > 0 && !isHidden("DISCORD") && renderTemplate`<a${addAttribute(DISCORD, "href")} title="Discord" target="_blank" data-astro-cid-hpnw4vwy> <img${spreadAttributes(discord)} alt="Discord Invite" class="social-icon" width="1em" data-astro-cid-hpnw4vwy> </a>`} ${MASTODON && MASTODON.length > 0 && !isHidden("MASTODON") && renderTemplate`<a${addAttribute(`https://${MASTODON}`, "href")} title="Mastodon" target="_blank" data-astro-cid-hpnw4vwy> <img${spreadAttributes(mastodon)}${addAttribute(`@${MASTODON}`, "alt")} class="social-icon" width="1em" data-astro-cid-hpnw4vwy> </a>`} ${BLUESKY && BLUESKY.length > 0 && !isHidden("BLUESKY") && renderTemplate`<a${addAttribute(`https://bsky.app/profile/${BLUESKY}`, "href")} title="BlueSky" target="_blank" data-astro-cid-hpnw4vwy> <img${spreadAttributes(bluesky)}${addAttribute(`@${BLUESKY}`, "alt")} class="social-icon" width="1em" data-astro-cid-hpnw4vwy> </a>`} </div> </div> ${introHTML && renderTemplate`<div class="text-box" id="site-intro" data-astro-cid-hpnw4vwy>${unescapeHTML(introHTML)}</div>`} `;
