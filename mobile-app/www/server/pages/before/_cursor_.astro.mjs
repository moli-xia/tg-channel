...
const $$cursor = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const channel = await getChannelInfo(Astro2, {
    before: Astro2.params.cursor
  });
  channel.seo = {
    noindex: true
  };
  return renderTemplate`${renderComponent($$result, "List", $$List, { "channel": channel })}`;
}, "/www/wwwroot/baoxiao.fun/app/src/pages/before/[cursor].astro", void 0);

const $$file = "/www/wwwroot/baoxiao.fun/app/src/pages/before/[cursor].astro";
const $$url = "/before/[cursor]";
